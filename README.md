...
- Sort glyphs by various criteria (newest, oldest, rarity, alphabetical)
...
```shellscript
tsx scripts/schedule-import.ts
```

### Resetting the Import Process

You can reset the import process to a specific block height through the admin panel or by using the API:
